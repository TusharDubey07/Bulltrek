export default function AlgoTrading() {
    return (
      <div className="max-w-7xl mx-auto px-4 py-16">
        <h1 className="text-4xl font-medium text-center mb-16">Algo Trading?</h1>
  ...
  <div className="mr-10">
            ...
            <div className="flex items-center gap-6 mt-4">
              <div className="flex-1 text-right">
                <h3 className="text-xl font-medium mb-2">Lorem Ipsum Dol</h3>
            ...
            <div className="flex items-center gap-6">
              <div className="flex-1 text-right">
                <h3 className="text-xl font-medium mb-2">Lorem Ipsum Dolor Sit Amer Dolo</h3>
                <p className="text-gray-600">Lorem ipsum dolor sit amet, consectetur adipiscing elit. cidunt justo interdum. Asuscipit elit gravNu</p>
              </div>
              <div className="w-16 h-16 rounded-full bg-pink-100 flex items-center justify-center">
                <div className="w-8 h-8">💹</div>
